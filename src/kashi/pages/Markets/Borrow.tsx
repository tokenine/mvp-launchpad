                        ...
                        pairs.items.map(pair => {
                            return (
                                <div key={pair.address}>
                                    ...
                                    >
                                        <div className="grid gap-4 grid-cols-4 md:grid-cols-6 lg:grid-cols-7 py-4 px-4 items-center align-center text-sm  rounded bg-dark-800 hover:bg-light-green">
