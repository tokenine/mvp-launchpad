...
import useMiniChef from '../../hooks/minichef/useMiniChefV2'
...
import { MINI_CHEF_V2_ADDRESS } from '../../../../constants/farms'
...
export default function InputGroup({
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        MINI_CHEF_V2_ADDRESS
    )

    const { deposit, withdraw, harvest } = useMiniChef()
                ...
                <div className="grid gap-4 grid-cols-2 px-4">
                    ...
                    <div className="text-center col-span-2 md:col-span-1">
                        ...
                        <div className="flex items-center relative w-full mb-4">
                            <NumericalInput
                                className="w-full p-3 bg-white rounded focus:ring focus:ring-blue pr-20"
                                value={depositValue}
                                onUserInput={value => {
                    ...
                    <div className="text-center col-span-2 md:col-span-1">
                        ...
                        <div className="flex items-center relative w-full mb-4">
                            <NumericalInput
                                className="w-full p-3  bg-white rounded focus:ring focus:ring-pink pr-20"
                                value={withdrawValue}
                                onUserInput={value => {
